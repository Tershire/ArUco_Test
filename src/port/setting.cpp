...
void Setting::read_and_set_raspberry_camera()
{
    ...
    if (camera_model == "Pinhole")
    {
        ...
        // extrinsics       
        raspberry_camera_= std::make_shared<Pinhole>(intrinsic_parameters);
    }
    else if (camera_model == "Brown-Conrady")
    {
        ...
        // extrinsics       
        raspberry_camera_= std::make_shared<Brown_Conrady>(intrinsic_parameters);
    }
    else
    {
        std::cerr << "Error: " << camera_model << " not known" << std::endl;
...
void Setting::read_and_set_color_imager()
{
    ...
    if (camera_model == "Pinhole")
    {
        ...
        // extrinsics       
        color_imager_= std::make_shared<Pinhole>(intrinsic_parameters);
    }
    else if (camera_model == "Brown-Conrady")
    {
        ...
        // extrinsics       
        color_imager_= std::make_shared<Brown_Conrady>(intrinsic_parameters);
    }
    else
    {
        std::cerr << "Error: " << camera_model << " not known" << std::endl;
